<%@ tag language="java" pageEncoding="ISO-8859-1"%>
  ...
  <div class="footer-content">
                ...
                <div class="footer-col connect col-md-6 col-sm-12 col-xs-12">
                    <div class="footer-col-inner">
                        ...
                        <div class="form-container">
                            <p class="intro">Stay up to date with the latest news and offers from Truck on rent</p>
                        ...
                        <p class="adr clearfix">
                            <i class="fa fa-map-marker pull-left"></i>
                                <span class="adr-group pull-left">
                                    <span class="street-address">3rd Cross Location</span><br>
                                    <span class="region">Outer Ring Road</span><br>
                                    <span class="postal-code">560103</span><br>
                                    <span class="country-name">India</span>
                                </span>
                        </p>
                        <p class="tel"><i class="fa fa-phone"></i>080123456789</p>
                        <p class="email"><i class="fa fa-envelope-o"></i><a href="#">contactus@truckonrent.com</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-bar">
        <div class="container">
            <small class="copyright">Copyright @ 2015 <a href="#" target="_blank">29partners</a></small>
        </div>
    </div>